                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <h5 class="card-title">{{ __('Chỉnh sửa tổ chức') }}</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Website:</label>
                            <input type="text" name="website" value="{{ old('website', $organization->website) }}"

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="platform" data-placeholder="{{ __('Chọn nền tảng') }}"
                                ...
                                <option {{ old('platform') == 'tiktok' ? 'selected' : null }} value="tiktok">
                                    TikTok</option>
                                <option {{ old('platform') == 'facebook' ? 'selected' : null }} value="facebook">
                                    Facebook</option>
                                <option {{ old('platform') == 'youtube' ? 'selected' : null }} value="youtube">
                                    Youtube</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content_type" class="form-control" placeholder="Dạng nội dung">{{ old('content_type') }}</textarea>
                        </div>


                        <div class="form-group">
                            <label>Người theo dõi:</label>
                            <input type="number" name="followers" value="{{ old('followers') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="engagement" value="{{ old('engagement') }}"
                                class="form-control @error('engagement')is-invalid @enderror" placeholder="">
                            @error('engagement')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="trust_score" value="{{ old('trust_score') }}"
                                class="form-control @error('trust_score')is-invalid @enderror" placeholder="">
                            @error('trust_score')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price_tiktok" value="{{ old('price_tiktok') }}"
                                class="form-control @error('price_tiktok')is-invalid @enderror" placeholder="">
                            @error('price_tiktok')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price_campaign" value="{{ old('price_campaign') }}"
                                class="form-control @error('price_campaign')is-invalid @enderror" placeholder="">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="is_verified"
                                    {{ old('is_verified', 1) == '1' ? 'checked' : null }} id="is_verified"
                                    value="1">
                                <label class="custom-control-label"
                                    for="is_verified">{{ __('Đã xác minh') }}?</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="is_featured"
                                    {{ old('is_featured') == '1' ? 'checked' : null }} id="is_featured"
                                    value="1">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="blue_tick"
                                    {{ old('blue_tick') == '1' ? 'checked' : null }} id="blue_tick" value="1">

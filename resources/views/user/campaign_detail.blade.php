                    ...
                    <div class="progress-overview">
                        <div class="progress-header">
                            <div>
                                ...
                                <div style="font-size: 14px; color: var(--gray-600); margin-top: 0.25rem;">15 days remaining</div>
                            </div>
                        ...
                        <table class="kol-performance-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="kol-info-cell">
                                            <div class="kol-avatar-small" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">MT</div>
                                            <div class="kol-details">
                                ...
                                <tr>
                                    <td>
                                        <div class="kol-info-cell">
                                            <div class="kol-avatar-small" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">AP</div>
                                            <div class="kol-details">
                    ...
                    <div class="tab-content" id="content-tab" style="display: none;">
                        <div class="content-feed">
                            ...
                            <div class="content-card">
                                ...
                                <div class="content-body">
                                    <div class="content-creator">
                                        <div class="creator-avatar" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">MT</div>
                        ...
                        <div class="timeline-container">
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="timeline-description">Campaign reached 10M total views across all KOL content</div>
                                </div>
                            </div>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="timeline-description">@linhnguyen_beauty posted summer collection showcase video</div>
                                </div>
                            </div>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="timeline-description">50% of campaign duration completed with 65% of goals achieved</div>
                                </div>
                            </div>
                        </div>
                    </div>

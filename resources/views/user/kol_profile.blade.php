                ...
                <div class="content-grid">
                    ...
                    <div>
                        ...
                        <div class="metric-card" style="margin-top: 2rem;">
                            <div class="metric-header">
                                ...
                                <a href="#" style="color: var(--primary); font-size: 14px; text-decoration: none;">View All →</a>
                            </div>
                            ...
                            <div class="content-list">
                                <div class="content-item">
                                    ...
                                    <div class="content-details">
                                        <div class="content-title">Summer Fashion Haul 2025 - Must Have Items for Your Wardrobe</div>
                                ...
                                <div class="content-item">
                                    <div class="content-thumbnail"></div>
                                    <div class="content-details">
                                        <div class="content-title">My Morning Skincare Routine - Products I'm Loving Right Now</div>
                                        <div class="content-stats">
                                            <span class="content-stat">
                                                <svg width="14" height="14" fill="currentColor" viewBox="0 0 20 20">
                                                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
                    ...
                    <div>
                        ...
                        <div class="metric-card" style="margin-top: 2rem;">
                            ...
                            <div style="margin-top: 1rem; padding: 1rem; background: var(--primary-lighter); border-radius: 8px;">
                                <div style="display: flex; align-items: center; gap: 0.5rem; color: var(--primary); font-size: 14px;">
                                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20">

                    ...
                    <div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" placeholder="e.g., Summer Fashion Collection 2024" value="Summer Fashion Collection 2024">
                            </div>
                        ...
                        <div class="form-section" style="margin-top: 1.5rem;">
                            ...
                            <div class="kol-selection-grid">
                                ...
                                <div class="kol-select-card selected">
                                    <input type="checkbox" class="kol-checkbox" checked>
                                    <div class="kol-avatar" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">MT</div>
                                    <div class="kol-info">
                                ...
                                <div class="kol-select-card">
                                    ...
                                    <div class="kol-avatar" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">TH</div>
                                    <div class="kol-info">
                        ...
                        <div class="form-section" style="margin-top: 1.5rem;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" value="#OneUpFashion #SummerVibes #SustainableStyle #GenZFashion">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="preview-panel">
                        ...
                        <div class="preview-card">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;">
                                ...
                                <div style="display: flex; align-items: center; gap: 0.75rem;">
                                    <div class="kol-avatar" style="width: 36px; height: 36px; font-size: 14px; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">MT</div>
                                    <div style="flex: 1;">
    ...
    <script>
        ...
        function updateSelectedKOLs() {
            ...
            if (selected > 0) {
                ...
                document.querySelector('.preview-item:nth-child(4) .preview-value').textContent = `₫${avgCost.toFixed(0)}M avg`;
            }
        }

                ...
                <div class="podium-section">
                    <div class="podium-container">
                        ...
                        <div class="podium-card">
                            ...
                            <div class="podium-avatar" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">MT</div>
                        ...
                        <div class="podium-card">
                            ...
                            <div class="podium-avatar" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">AP</div>
                    ...
                    <table class="ranking-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="kol-cell">
                                        <div class="kol-avatar-small" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%);">HV</div>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span class="rank-change change-down">
                                        <svg width="12" height="12" fill="currentColor" viewBox="0 0 20 20" style="transform: rotate(180deg);">
                                            <path fill-rule="evenodd" d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
                                        </svg>
                                        1
                                    </span>
                                ...
                                <td>
                                    <div class="kol-cell">
                                        <div class="kol-avatar-small" style="background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%);">TL</div>
                                        <div class="kol-details">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="kol-cell">
                                        <div class="kol-avatar-small" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">DN</div>
                                        <div class="kol-details">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="kol-cell">
                                        <div class="kol-avatar-small" style="background: linear-gradient(135deg, #f6d365 0%, #fda085 100%);">TH</div>
                                        <div class="kol-details">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="kol-cell">
                                        <div class="kol-avatar-small" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">NH</div>
                                        <div class="kol-details">

...
@section('meta')
    ...
    <title>Forgot Password - OneUp KOL Analytics</title>
    ...
    <div class="auth-container">
        ...
        <div id="resetForm">
            ...
            <div class="reset-steps">
                <div class="reset-step">
                    ...
                    <div class="step-content">
                        ...
                        <div class="step-description">We'll send a password reset link to your email</div>
                    </div>
                </div>
                <div class="reset-step">
                    <div class="step-number">2</div>
                    <div class="step-content">
                        <div class="step-title">Click Reset Link</div>
                        <div class="step-description">Open the email and click on the secure reset link</div>
                    </div>
                </div>
                <div class="reset-step">
                    ...
                    <div class="step-content">
                        ...
                        <div class="step-description">Choose a strong new password for your account</div>
                    </div>
                </div>
            </div>
            ...
            <div class="security-note">
                ...
                <div class="security-text">
                    For security reasons, the reset link will expire in 1 hour. If you don't receive an email within 5 minutes, please check your spam folder.
                </div>
            </div>
        ...
        <div id="successState" class="success-state">
            ...
            <p class="success-message">
                ...
                <strong id="emailDisplay">your email address</strong>
            </p>
            ...
            <div class="security-note">
                ...
                <div class="security-text">
                    Didn't receive the email? Check your spam folder or try resending. If you still have issues, contact our support team.
                </div>
            </div>

...
@section('meta')
    ...
    <title>Login - OneUp KOL Analytics</title>
...
@section('page')
    <div class="auth-container">
        ...
        <div class="auth-left">
            ...
            <p class="auth-subtitle">Login to access your KOL analytics dashboard</p>
            ...
            <div class="signup-prompt">
                Don't have an account? <a href="{{route('register')}}" class="link">Sign up for free</a>
            </div>
        </div>
        ...
        <div class="auth-right">
            <div class="auth-visual">
                <h2 style="font-size: 28px; margin-bottom: 1rem;">Unlock Powerful Analytics</h2>
                <p style="font-size: 16px; opacity: 0.9; margin-bottom: 2rem;">
                    Join 500+ brands using OneUp KOL to optimize their TikTok influencer campaigns
                </p>
                ...
                <ul class="feature-list">
                    <li>
                        ...
                        <div class="feature-text">
                            <h4>Smart KOL Discovery</h4>
                            <p>Find perfect influencers with AI-powered recommendations</p>
                        </div>
                    </li>
                    <li>
                        <div class="feature-icon">📊</div>
                        <div class="feature-text">
                            ...
                            <p>Track campaign performance with live metrics</p>
                        </div>
                    </li>
                    <li>
                        <div class="feature-icon">💰</div>
                        <div class="feature-text">
                            ...
                            <p>Maximize your return with data-driven insights</p>
                        </div>
                    </li>
                </ul>
                ...
                <div class="auth-stats">
                    ...
                    <div class="auth-stat">
                        ...
                        <span class="auth-stat-label">Brands</span>
                    </div>
                    <div class="auth-stat">

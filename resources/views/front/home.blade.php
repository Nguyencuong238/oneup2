        ...
        <div class="container">
            ...
            <div class="grid grid-3">
                ...
                <div class="feature-box fade-in" style="animation-delay: 0.1s;">
                    ...
                    <p>Review detailed metrics including audience demographics, content performance, and authenticity scores.</p>
                </div>
    ...
    <section class="section">
        <div class="container">
            <div class="section-header">
                ...
                <h2 class="section-title fade-in">Everything You Need to Succeed</h2>
            </div>
        ...
        <div class="container">
            ...
            <div class="grid grid-3">
                <div class="card fade-in">
                    ...
                    <p class="mb-3" style="font-style: italic; color: var(--gray-700);">
                        "OneUp KOL helped us increase our ROI by 300% in just 3 months. The AI recommendations are incredibly accurate."
                    </p>
                    <div class="d-flex align-center gap-2">
                        <div class="kol-avatar">NT</div>
                        <div>
                            <strong>Nguyễn Thảo</strong><br>
                            <small style="color: var(--gray-600);">Marketing Director, Fashion Brand</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card fade-in" style="animation-delay: 0.1s">
                    ...
                    <p class="mb-3" style="font-style: italic; color: var(--gray-700);">
                        "The fraud detection feature saved us from wasting budget on fake influencers. Essential tool for any marketer."
                    </p>
                    <div class="d-flex align-center gap-2">
                        <div class="kol-avatar">LM</div>
                        <div>
                            <strong>Lê Minh</strong><br>
                            <small style="color: var(--gray-600);">CEO, Tech Startup</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card fade-in" style="animation-delay: 0.2s">
                    ...
                    <p class="mb-3" style="font-style: italic; color: var(--gray-700);">
                        "Real-time tracking helps us optimize campaigns on the fly. We've seen 5x improvement in engagement rates."
                    </p>
                    <div class="d-flex align-center gap-2">
                        <div class="kol-avatar">PH</div>
                        <div>
                            <strong>Phạm Hương</strong><br>
                            <small style="color: var(--gray-600);">CMO, Beauty Company</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cta-split">
                <div class="cta-content">
                    ...
                    <div class="d-flex gap-2" style="margin-top: 2rem;">
                        ...
                        <a href="{{route('pricing')}}" class="btn" style="background: rgba(255,255,255,0.2); color: white; border: 2px solid white;">
                            View Pricing
                        </a>
                    </div>
                </div>
